import { useGetTvShowRecommendationQuery } from "../apis/TvShowApi";
import TvShowCard from "../components/TvShowCard";

const TvShowRecommendation = ({ tvId }) => {
  const { data } = useGetTvShowRecommendationQuery(tvId);
...
export default TvShowRecommendation